...
public:
	...
	virtual void checks(){
		// if(VEX_TOP->writeBack_RegFilePlugin_regFileWrite_valid == 1 && VEX_TOP->writeBack_RegFilePlugin_regFileWrite_payload_address != 0){
		// 	assertEq(VEX_TOP->writeBack_RegFilePlugin_regFileWrite_payload_address, regFileWriteRefArray[regFileWriteRefIndex][0]);
		// 	assertEq(VEX_TOP->writeBack_RegFilePlugin_regFileWrite_payload_data, regFileWriteRefArray[regFileWriteRefIndex][1]);
		// 	//printf("%d\n",i);
