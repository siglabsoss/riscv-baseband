#include "Vriscv_baseband.h"
#include "Vriscv_baseband_riscv_baseband.h"
#include "Vriscv_baseband_VexRiscv.h"
#include "Vriscv_baseband_q_engine.h"
#include "Vriscv_baseband_scalar_memory.h"
...
#define MEM_BANK_0 top->riscv_baseband->q_engine->mem->mem0
#define MEM_BANK_1 top->riscv_baseband->q_engine->mem->mem1
#define MEM_BANK_2 top->riscv_baseband->q_engine->mem->mem2
#define MEM_BANK_3 top->riscv_baseband->q_engine->mem->mem3
...
//		cout << "Start " << name << endl;
		...
		uint32_t pf0 = (0x400) / 4;
		uint32_t pf1 = (0x404) / 4;
		...
		cout << "Test Value: " <<  (void*) pass_fail_0 << endl;
...
class DumpXBB : public Workspace{
public:

	uint32_t regFileWriteRefIndex = 0;
	uint32_t dma_input;

	DumpXBB() : Workspace("dump_xbb") {
