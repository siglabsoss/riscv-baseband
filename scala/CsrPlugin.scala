...
class CsrPlugin(config : CsrPluginConfig) extends Plugin[VexRiscv] with ExceptionService with PrivilegeService with InterruptionInhibitor with ExceptionInhibitor with IContextSwitching with CsrInterface{
  ...
  var externalInterrupt : Bits = null
  ...
  override def setup(pipeline: VexRiscv): Unit = {
    ...
    externalInterrupt = in Bits(6 bits) setName("externalInterrupt")
  ...
  override def build(pipeline: VexRiscv): Unit = {
    ...
    pipeline plug new Area{
      ...
      val mip = new Area{
        val MEIP = RegNext(externalInterrupt) init(0)
        val MTIP = RegNext(timerInterrupt) init(False)
        val MSIP = RegInit(False)
      }
      val mie = new Area{
        val MEIE = RegInit(U"000000")
        val MTIE, MSIE = RegInit(False)
      }
      ...
      READ_ONLY(CSR.MIP, 31 -> mip.MEIP(5), 27 -> mip.MEIP(4), 23 -> mip.MEIP(3), 19 -> mip.MEIP(2), 15 -> mip.MEIP(1), 11 -> mip.MEIP(0), 7 -> mip.MTIP)
      READ_WRITE(CSR.MIP, 3 -> mip.MSIP)
      READ_WRITE(CSR.MIE, 31 -> mie.MEIE(5), 27 -> mie.MEIE(4), 23 -> mie.MEIE(3), 19 -> mie.MEIE(2), 15  -> mie.MEIE(1), 11 -> mie.MEIE(0), 7 -> mie.MTIE, 3 -> mie.MSIE)
      ...
      val interruptRequest = ((mip.MSIP && mie.MSIE) || (mip.MEIP(5) && mie.MEIE(5)) || (mip.MEIP(4) && mie.MEIE(4)) || (mip.MEIP(3) && mie.MEIE(3)) || (mip.MEIP(2) && mie.MEIE(2)) || (mip.MEIP(1) && mie.MEIE(1)) || (mip.MEIP(0) && mie.MEIE(0)) || (mip.MTIP && mie.MTIE)) && mstatus.MIE
...
//      }
      ...
      when(exception || (interrupt && pipelineLiberator.done)){
        ...
        mcause.exceptionCode := ((mip.MEIP(5) && mie.MEIE(5)) ? U(31) |
          ((mip.MEIP(4) && mie.MEIE(4)) ? U(27) |
          ((mip.MEIP(3) && mie.MEIE(3)) ? U(23) |
          ((mip.MEIP(2) && mie.MEIE(2)) ? U(19) |
          ((mip.MEIP(1) && mie.MEIE(1)) ? U(15) |
          ((mip.MEIP(0) && mie.MEIE(0)) ? U(11) |
          ((mip.MSIP && mie.MSIE) ? U(3) | U(7))))))))
      }
