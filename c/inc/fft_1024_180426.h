#ifndef __FFT_1024_OPT_H__
#define __FFT_1024_OPT_H__
...
fft1024_t get_fft1024_plan( unsigned int input_row,
                            unsigned int output_row) {
  return (fft1024_t) {
      VMEM_ROW_ADDRESS(data_cfg),
...
void fft_1024_run(fft1024_t* plan)
{
  //register volatile unsigned int x3 asm("x3");

  int cfg_location = plan->cfg_location;
  int twddle_location_0 = plan->twddle_location_0;
  int twddle_location_1 = plan->twddle_location_1;
  int twddle_location_2 = plan->twddle_location_2;
  int twddle_location_3 = plan->twddle_location_3;
  int twddle_location_4 = plan->twddle_location_4;

  // // row index
  int bank_address_location_0 = plan->bank_address_location_0;
  int bank_address_location_1 = plan->bank_address_location_1;
  int permutation_address_location_1 = plan->permutation_address_location_1;
  int bank_address_location_2 = plan->bank_address_location_2;
  int bank_address_location_3 = plan->bank_address_location_3;
  int permutation_address_location_3_LK9 = plan->permutation_address_location_3_LK9;
  int permutation_address_location_3_SK1 = plan->permutation_address_location_3_SK1;
  int bank_address_location_4 = plan->bank_address_location_4;

  int data_location = plan->data_location;
  int data_location_0 = plan->data_location_0;
...
int fft_1024_result_check(int benchmark_start_row, int result_start_row, int total_sample)
{
  ...
  for(int index=0; index<total_sample;index++)
  {
    ...
    // report_test_results(diff_real);
    // report_test_results(diff_imag);
...
void fft1024_4(int data_location_0, int twddle_location_4, int bank_address_location_4)
{
  ...
  for(int index_stage4; index_stage4<3; index_stage4++)
  {
